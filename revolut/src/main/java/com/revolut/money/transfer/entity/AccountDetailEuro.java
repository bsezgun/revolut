 ...
 * @category Entity
 * @comment
 *  This class is in-memory <b>AccountDetailEuro</b> H2 Database table.<br/> accountDetailId column is automatically increased if it is not set.
 *  <br/>accountId is the foreign key of AccountEuro table.
 * 	@since 2018-09-19
 *  @version v.1.0.1
 */
@Entity
